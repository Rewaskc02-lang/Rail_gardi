...
const CATERING_MENU = [
  { id: "item-1", name: "Executive Veg Thali", category: "Full Meal", price: "₹150" },
  { id: "item-2", name: "Masala Chai & Samosa Combo", category: "Hot Snacks", price: "₹50" },
  { id: "item-3", name: "Paneer Grilled Sandwich", category: "Snacks", price: "₹80" }
];
...
export default function PassengerPage() {
  ...
  useEffect(() => {
    ...
    function handleLoginSuccess({ passengerInfo }) {
      if (!passengerInfo) return;
      setIsLoggedIn(true);
      setPassengerName(passengerInfo.passengerName);
      setAssignedSeat({
        coach: passengerInfo.coach,
        seat: passengerInfo.seat,
        berth: passengerInfo.berth
      });
      setSelectedSeat(passengerInfo.seat);
      setLoginError("");
    }

    function handleLoginError({ message }) {
      setLoginError(message || "Invalid PNR");
    }
  ...
  function handleLogin(e) {
    e.preventDefault();
    setLoginError("");
    socket.emit("login_pnr", { pnr: pnrInput.trim() });
  }
